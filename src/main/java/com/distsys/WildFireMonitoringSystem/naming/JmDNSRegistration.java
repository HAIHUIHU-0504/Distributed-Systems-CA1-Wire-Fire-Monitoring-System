...
public class JmDNSRegistration {
    ...
    private static JmDNSRegistration theRegister;

    /**
     * JmDNSRegistration uses the Singleton pattern. Only one instance
     ...
     */
    private JmDNSRegistration() throws UnknownHostException, IOException {
     ...
     * @throws IOException
     */
    public static JmDNSRegistration getInstance() throws IOException {
        if (theRegister == null) {
            theRegister = new JmDNSRegistration();
        }
        return theRegister;
